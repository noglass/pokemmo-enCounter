...
class CreateToolTip(object):
    ...
    """
    def __init__(self, widget, text='小部件信息'):
...
undoButton = tk.Button(text='撤销上次', image=pixelVirtual, width=15, height=7, compound='c', command=undo, bg='grey', fg='white', activebackground='black', activeforeground='white')
...
resetButton = tk.Button(text='重置', image=pixelVirtual, width=15, height=7, compound='c', command=reset, bg='grey', fg='white', activebackground='black', activeforeground='white')
